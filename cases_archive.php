        ...
        <div class="dropdown ms-3">
            ...
            <section class="documents-management">
                ...
                <div class="document-list">
                    <center><h3>REPORTED CASES ARCHIVE</h3></center>
                    <table id="doc-table">
                    <thead>
                        <tr>
                            <th>Case No:</th>
                    ...
                    <?php
                    $sql = "SELECT * FROM cases WHERE isArchive = 1";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            $docName = $row['Title'];                            
                            $workOrderId = $row['id'];
                            echo "<form action='restorecase.php' method='GET' style='display:inline' id='frm-$workOrderId' onSubmit='return confirm(\"Are you sure to restore: $docName?\")'>";
