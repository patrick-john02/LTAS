...
<body>
        ...
        <div class="dropdown">
            ...
            <section class="documents-management">
                ...
                <div class="document-list">
                    <center><h3>ALL ORDINANCES SENT</h3></center>
                    <table id="doc-table">
                    <thead>
                        <tr>
                            <th>Ordinance No.</th>
    ...
    <div class="form-content">
        ...
        <h2>Add Document</h2>
        <form method="POST" action="addordinance.php" enctype="multipart/form-data">
            <div class="form-group" style="display:none">
                <label for="id">Document ID</label>
                <input type="text" id="id" name="id" value="<?= $_SESSION['userid']; ?>" readonly>
            </div>
            <div class="form-group">
                <label for="id">Ordinance #</label>
            ...
            <!-- Automatically fill Category as Ordinances -->
            <input type="hidden" id="Documents-type" name="Documents-type" value="Ordinances">
            <div class="form-group">
        ...
        <div id="edit-workorder-form" class="popup-form" style="display:none">
            <div class="form-content">
                <span class="close">&times;</span>
                <h2>Edit Document</h2>
                <form method="POST" name="edit_form" id="edit_form" action="updateordinance.php" enctype="multipart/form-data">
                    <div class="form-group" style="display:none">
                        <label for="id">Document ID</label>
                    ...
                    <div class="form-group">
                        <label for="id">Ordinance #</label>
                        <input type="text" id="edit_doc_no" name="edit_doc_no" value="">
                    </div>
                    <div class="form-group">
                        <label for="title">Title</label>
