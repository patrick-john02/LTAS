    ...
    <div class="user-name d-flex align-items-center">
        ...
        <div class="dropdown">
            ...
            <section class="documents-management">
                ...
                <div class="document-list">
                    ...
                    <?php
                     $sql = "SELECT * FROM documents WHERE isArchive = 0 AND Category = 'Memorandum'";
        ...
        <div id="addform" class="popup-form" style="display:none">
            <div class="form-content">
                ...
                <h2>Add Memorandum Document</h2>
                <form method="POST" action="adddocuments.php" enctype="multipart/form-data">
                    <?php
                        $sql = "SELECT MAX(id) as `mm` FROM documents";
                        $result = $conn->query($sql);
                        $row = $result->fetch_assoc();
                        $last = $row['mm'] + 1;
                    ?>
                    <div class="form-group" style="display:none">
                        <label for="id">Memo Order #: </label>
                        <input type="text" id="id" name="id" value="<?php echo $last;?>" readonly>
                    </div>
        ...
        <div id="edit-workorder-form" class="popup-form" style="display:none">
            <div class="form-content">
                <span class="close">&times;</span>
                <h2>Edit Memorandum Document</h2>
