...
$dateQuery = "SELECT DISTINCT `Date Published` FROM `documents` WHERE `CATEGORY` = 'Resolution' AND `d_status` = 'Approved'";
$dateResult = $conn->query($dateQuery);

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Get the selected date from the form
    $selectedDate = isset($_POST['date_published']) ? $_POST['date_published'] : '';
...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" action="ListResolutionReport.php">
            <div class="mb-3">
