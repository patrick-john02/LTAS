        ...
        <div class="dropdown">
            ...
            <section class="Documents-management">
                ...
                <div class="document-list">
                    ...
                    <center> <h3>ARCHIVED SESSIONS</h3></center>
                    <table id="doc-table">
                    <thead>
                        <tr>
                    ...
                    // Your SQL query
                    $sql = "SELECT * FROM sessions WHERE isArchive = 1";
                    ...
                    if ($result === false) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $workOrderId = $row['id'];
                                echo "<form action='restoresession.php' method='GET' style='display:inline' id='frm-$workOrderId' onSubmit='return confirm(\"Are you sure to restore: $docName?\")'>";
                                echo "<input type='hidden' name='id' value='". $workOrderId . "'>";
                                echo "<input type='submit' name='delete' class='delete-button' value='Restore'></form>";
