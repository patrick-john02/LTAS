...
<body>
    <div class="container" style="margin-left: 100px;">
        ...
        <main style="margin-left: 230px; margin-right: 100px; padding: 10px 10px; display: inline-block;">
        <header>
    ...
    <div class="tab-panels">
        <section id="resolution" class="tab-panel">
            <div class="document-list">
                <center><h3>INCOMING RESOLUTION DOCUMENTS LIST</h3></center>
                <table id="doc-table">
                    <thead>
                    <tr>
                        <th>Resolution No</th>
                    ...
                    <tbody>
                    <?php
                    $sql = "SELECT * FROM documents WHERE isArchive = 0 AND d_status = 'Pending' AND Category = 'Resolution'";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            if (!empty($row['user_id'])) {
                                ...
                                $uid = ($sql2 && $sql2->num_rows > 0) ? $sql2->fetch_assoc()['Username'] : "Unknown User";
                            } else {
                                $uid = "Unknown User";
                            }
                            echo "<td>" . $uid . "</td>";
        ...
        <section id="ordinance" class="tab-panel">
            <div class="document-list">
                <center><h3>INCOMING ORDINANCE DOCUMENTS LIST</h3></center>
                <table id="doc-table-ord">
                    ...
                    <tbody>
                    <?php
                    $sql = "SELECT * FROM documents WHERE isArchive = 0 AND d_status = 'Pending' AND Category = 'Ordinances'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
