...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2024 at 10:54 PM
...
(90, 'DOC-94', 'Implementation of Sustainability Initiatives', 'This resolution authorizes the introduction of a series of sustainability initiatives aimed at reduc', 'kheriz', '2024-12-16 06:34:10', 'Ordinance', 'uploads/Module-3-Pointers-and-Linked-Lists (1).pdf', 9, 'Second Reading', 1, NULL, 'ORDINANCE NO. 6 SERIES OF 2024', NULL),
(96, 'DOC-96', 'pppp', 'ppp', 'pppp', '2024-12-18 00:00:00', 'Resolution', 'uploads/sample.pdf', 1, 'Approved', 0, 'RESOLUTION NO. 2024-13', NULL, '2024-12-17 22:58:42'),
(98, 'DOC-98', 'nnn', 'nnn', 'nnn', '2024-12-19 00:00:00', 'Resolution', 'uploads/pdf.pdf', 1, 'First Reading', 0, 'RESOLUTION NO. 2024-15', NULL, NULL),
(100, 'DOC-92', 'ordinance for officers', 'this is a sample description', 'sample author', '2024-12-17 00:00:00', 'Ordinance', 'uploads/sample.pdf', 1, 'Pending', 0, '', 'ORDINANCE NO. 9 SERIES OF 2024', NULL),
(101, 'DOC-101', 'This is a title', 'this is a des', 'this is the aut', '2024-12-17 12:40:00', 'Resolution', 'uploads/sample.pdf', 1, 'Pending', 1, 'RESOLUTION NO. 2024-12-0000001', NULL, NULL),
(102, 'DOC-102', 'not this ', 'not this', 'not his', '2024-12-17 12:43:00', 'Resolution', 'uploads/sample.pdf', 1, 'Pending', 1, 'RESOLUTION NO. 2024-12-0000002', NULL, NULL),
(103, 'DOC-103', 'this is ord', 'ord', 'ord', '2024-12-17 12:44:00', 'Ordinance', 'uploads/sample.pdf', 9, 'Pending', 0, NULL, 'ORDINANCE NO. 10 SERIES OF 2024', NULL),
(107, NULL, 'reso', 'reso', 'Kheriz Somera', '2024-12-17 17:48:00', 'Resolution', 'uploads/sample.pdf', 9, 'Pending', 0, 'RESOLUTION NO. 2024-12-0000002', NULL, NULL),
(108, NULL, 'dsadas', 'sdadsadas', 'Kheriz Somera', '2024-12-17 16:50:00', 'Resolution', 'uploads/sample.pdf', 9, 'Pending', 0, 'RESOLUTION NO. 2024-12-0000003', NULL, NULL);
...
CREATE TABLE `document_timeline` (
  ...
  `action` enum('Pending','First Reading','Second Reading','Approve','Reject') NOT NULL,
...
(60, 'khez', 'BrvzkhyX', 'User', 'kheriz', 'somera', 'Secretary', 'kherizsomera@gmail.com', 'Legislative', 'Inactive', NULL, 0);
