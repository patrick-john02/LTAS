        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="documents view.php">Documents Management</a></li>
        ...
        <main>
            ...
            <section class="documents-management">
                ...
                <div class="document-list">
                    <center><h3>ORDINANCES DOCUMENTS LIST</h3></center>
                    <table id="doc-table">
                    <thead>
                        <tr>
                            <th>Doc ID</th>
                    ...
                    <?php
                    $uid = $_SESSION['userid'];
                    $sql = "SELECT * FROM documents WHERE user_id = $uid AND Category = 'Ordinances'";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            $docName = $row['Title'];                            
                            $workOrderId = $row['id'];
                            echo "<form action='deletedocument.php' method='GET' style='display:inline' id='frm-$workOrderId' onSubmit='return confirm(\"Are you sure to delete: $docName?\")'>";
                            echo "<input type='hidden' name='id' value='". $workOrderId . "'>";
                            echo "<input type='submit' name='delete' class='delete-button' value='Delete'></form>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    } 
                ...
                <form method="POST" action="adddocuments.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="Documents-type" name="Documents-type" required>
                            ...
                            <option value="Ordinances" selected>Ordinances</option>
                        </select>
                    </div>
                    <div class="form-group">
